...
* 3.2 [Private ssh key for connecting and uploading to remote<br> server](https://github.com/theSpeare/RPi_ADXL#32-private-ssh-key-for-connecting-and-uploading-to-remote-server)<br>
